...
from .dat_blocks import DAttentionBaseline, DeformableAttention_gy, LocalAttention, ShiftWindowAttention_mm
...
class Attention(nn.Module):
    def __init__(
        ...
        self.diffential_att = True    # self.pixel_crossattention must be True
        ...
        if self.pixel_crossattention:
            ...
            for bs in range(B):
                ...
                if self.diffential_att:
                    ...
                    k = torch.cat([noise_k + diff_noise1, torch.mul(q, relation_score)], dim=0) # (2,N,C)
                ...
                if self.diffential_att:
                    ...
                    k = torch.cat([noise_k + diff_noise2, torch.mul(q, relation_score)], dim=0)
